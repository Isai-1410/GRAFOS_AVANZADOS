...
namespace EditordeGrafos
{
    public partial class Editor : Form
    {
        ...
        */
        ...
        private void EulerCir_Click(object sender, EventArgs e)
        {
            CircuitoEuleriano EuCi = new CircuitoEuleriano(graph);
            EuCi.ShowDialog();

        }

        private void ProfConv_Click(object sender, EventArgs e)
        {
